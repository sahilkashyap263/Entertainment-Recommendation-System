...
netflix_data = pd.read_csv(r'C:\Users\sahil\Desktop\Deep Learning\Netflix-Recommendation-System\Netflix-Recommendation-System-main\app\NetflixDataset.csv',encoding='latin-1', index_col = 'Title')
